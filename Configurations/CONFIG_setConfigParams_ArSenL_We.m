...
function [CONFIG_strParams] = CONFIG_setConfigParams_ArSenL_We()
    ...
    CONFIG_strParams.sInputDataWorkspace = [CONFIG_strParams.sConfigEnvPath '\input_data_ArSenL_We_1.mat'];
