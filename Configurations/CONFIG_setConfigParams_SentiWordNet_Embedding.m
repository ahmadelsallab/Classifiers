...
function [CONFIG_strParams] = CONFIG_setConfigParams_SentiWordNet_Embedding()
	...
	CONFIG_strParams.vSubClassTargets = 0:2;
    ...
    CONFIG_strParams.sInputDataWorkspace = [CONFIG_strParams.sConfigEnvPath '\input_data_SentiWordNet_Embedding_1.mat'];
    
    
    % Name of the input data structures workspace
    CONFIG_strParams.sNetDataWorkspace = [CONFIG_strParams.sConfigEnvPath '\final_net_SentiWordNet_embedding.mat'];
    ...
    CONFIG_strParams.nTrainToTestFactor = 250; % Nearly examples are train
...
%     CONFIG_strParams.bBreadthMapping = 1;
    ...
    CONFIG_strParams.nBPNumEpochsBeforeMapping = 2;
