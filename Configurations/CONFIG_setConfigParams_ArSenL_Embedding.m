...
function [CONFIG_strParams] = CONFIG_setConfigParams_ArSenL_Embedding()
    ...
    CONFIG_strParams.sInputDataWorkspace = [CONFIG_strParams.sConfigEnvPath '\input_data_ArSenL_Embedding_1.mat'];
    
    
    % Name of the input data structures workspace
    CONFIG_strParams.sNetDataWorkspace = [CONFIG_strParams.sConfigEnvPath '\final_net_ArSenL_embedding.mat'];
