...
% corresponding index.
function [nErr, vTargetOut, vTargets] = TST_computeClassificationErrNormalDNN(mBatchData, mBatchTargets, NM_strNetParams, bMapping, eMappingDirection, eMappingMode,...
    ...
    for ctrBatch = 1 : nNumBatches
        ...
        nErrReconstruction = nErrReconstruction + 1 /nNumExamples * (sum(sum( (mCurrBatchData - mCurrBatchTargetOut).^2 )));
